...
export default function SkupineDodaj(){

    const navigate = useNavigate();

    async function dodaj(skupina){
        const odgovor = await SkupinaService.dodaj(skupina);
        if(odgovor.greska){
    ...
    <Form onSubmit={odradiSubmit}>
        ...
        <Form.Group controlId="prostorija">
            ...
            <Form.Control type="text" name="prostorija"  />
        </Form.Group>
